...
export const allSlides: Slide[] = [
  ...
  { id: 'slide-21-1', number: 21.1, url: 'https://res.cloudinary.com/daxtfjb3u/image/upload/v1775228735/mevitol_b_all0nz.jpg', medicineName: 'mevitol b' },
  { id: 'slide-21-2', number: 21.2, url: 'https://res.cloudinary.com/daxtfjb3u/image/upload/v1775228734/nuroscan_x35xzk.jpg', medicineName: 'NEUROSCAN' },
